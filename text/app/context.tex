...
\addsnippet{0.9}{code/context-sensor}{\label{lst:context-sensor}Przykładowa fragment Contextu z
  informacjami dla konkretnego laboratorium}

\addsnippet{0.9}{code/context-functions}{\label{lst:context-functions}Funkcje przekazywane globalnie
