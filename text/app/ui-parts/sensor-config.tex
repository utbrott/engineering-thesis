...
składa się~z~par klucz-wartość. Klucz \colortt{sensor} określa do jakiego ćwiczenia laboratoryjnego
przynależą definiowane wartości, \colortt{id} wykorzystywany jest przy manipulowaniu stanem,
którego zadaniem jest przechowywanie informacji~o~obecnej konfiguracji sensora, natomiast \colortt
