Aplikacja została zaprojektowana~w~taki sposób, że do momentu zapisania konfiguracji niemożliwe jest
...
\colortt{hasData} -- informuje ona kod renderujący komponent~o~tym, czy należy wyświetlić dodatkową
