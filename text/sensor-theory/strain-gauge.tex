...
\addimage{0.75}{sensor-theory/strain-gauge}{\label{img:strain-gauge}Schemat układu mostkowego}

\addimage{0.8}{sensor-theory/strain-beam}{\label{img:strain-beam}Schemat przykładowego montażu
