...
\addimage{0.85}{sensor-theory/strain-gauge}{\label{img:strain-gauge}Schemat układu mostkowego}

\addimage{0.85}{sensor-theory/strain-beam}{\label{img:strain-beam}Schemat przykładowego montażu
  układu mostkowego na belce pomiarowej}
