...
\input{text/sensor-theory/rtd}

\FloatBarrier
\subsection{Termoogniwa}
\input{text/sensor-theory/thermocouple}

\subsection{Porównanie sensorów temperatury}
\input{text/sensor-theory/temperature-comparison}

\subsection{Charakterystyki dynamiczne sensorów temperatury}
\input{text/sensor-theory/dynamic-temperature.tex}
...
\input{text/sensor-theory/strain-gauge}