...
\begingroup
\addimage{0.9}{app-ui/tasks-not-done}{\label{img:tasks-not-done}Interfejs
  użytkownika~z~zablokowanym widokiem wykresu, gdy zadania nie są ukończone}
\addimage{0.9}{app-ui/tasks-done}{\label{img:tasks-done}Interfejs użytkownika~z~widocznym
