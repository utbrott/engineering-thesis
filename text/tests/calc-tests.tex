...
\begin{figure}[!htbp]
  ...
  \subfloat[][Wyniki dla ćwiczenia z
    termorezystorami]{\includegraphics[width=0.35\textwidth]{code/tests-rtd}\label{img:tests-rtd}}
  \hfill
  \subfloat[][Wyniki dla ćwiczenia z
    termoogniwami]{\includegraphics[width=0.35\textwidth]{code/tests-thermocouple}\label{img:tests-thermocouple}}
  \hfill
...
\addimage{0.7}{app-ui/graph-rtd}{\label{img:graph-rtd}Wygenerowana charakterystyka dla
  termorezystorów}

\addimage{0.7}{app-ui/graph-thermocouple}{\label{img:graph-thermocouple}Wygenerowana charakterystyka
  dla termoogniw}
